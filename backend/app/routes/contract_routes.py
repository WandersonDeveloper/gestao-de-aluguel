...
def create_contract(data: ContractCreate, db: Session = Depends(get_db)) -> ContractRead:
...
def activate_contract(
    contract_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)
) -> ContractRead:
